            ...
            <div className="relative size-[62px] flex items-center justify-center group/image">
              <Hint label="remove">
                <button
                  ...
                  className="hidden group-hover/image:flex rounded-full bg-destructive/70 hover:bg-destructive text-secondary absolute -top-2 -right-2 size-5 z-[4] items-center justify-center"
                >
